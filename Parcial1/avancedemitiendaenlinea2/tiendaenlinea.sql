...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-03-2025 a las 01:06:03
...
(1, 'comida', 'aqui va la comida'),
(2, 'objetos de baño', 'todos los objetos de baño');
...
(1, 'por el diablo', 22, 'palmito', 2008, 'sinaloa', 'culiacan ', 1);
...
INSERT INTO `lista_deseos` (`Id`, `Usuario_Id`) VALUES
(1, 1);
...
(2, 'carne con arroz', 'es carne con arroz\r\n', 1, 200, 10),
(3, 'esponja de baño', 'excelente esponja para bañarte', 2, 150, 1);
...
(1, 'hugo alejandro', 'rubio maldonado', 'hugo.rubio23@cetis107.edu.mx', '6674598915', '2008-08-22', 0);
